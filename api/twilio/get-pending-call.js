...
export default async function handler(req) {
  ...
  const supabaseRes = await fetch(`${supabaseUrl}?id=eq.${id}&select=id,employee_name,exam_id,employee_dob,client_name,appointment_time,type_of_visit,clinic_name,clinic_provider_address,clinic_scheduling_rep,procedures,employee_phone_number,employee_address,retry_count`, {
  headers: {
